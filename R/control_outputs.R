control_outputs <- function( fitted.mod=mod2,niter=10000, months.start=months_until_second_knot, set.vax.intro.date=vax.intro.date,set.months_until_second_knot=months_until_second_knot){
