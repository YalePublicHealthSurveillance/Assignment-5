...
You have been asked to evaluate the impact of the introduction of pneumococcal conjugate vaccine (PCV7) in the US. PCV7 was introduced for use in infants in the US in 2000, with a 4 dose schedule (doses at 2,4,6,12 months of age). These data come from hospitalizations from 8 large states (combined together). 
